...
dir_name = get_task_dirs("regression")
...
CONFIG = {
    # Data
    "source_data": PROCESSED_DATA_DIR / "featured_orders.csv",
...
test_metrics = evaluator.generate_full_report(output_dir= RESULTS_DIR / "regression")
...
# Save comparison
comparison_path = RESULTS_DIR / "regression/test_model_comparison.csv"
