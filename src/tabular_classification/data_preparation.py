...
class ModelDataPreparator:
    ...
    def separate_features_target(self, df: pd.DataFrame):
        ...
        drop_columns = [
            ...
            "overpromised",
            "delivery_efficiency",
            "price_delay_interaction",
            "value_per_delivery_day",
            "holiday_delivery_risk",
            "value_risk"
        ]
    ...
    def save_preprocessing_objects(self, save_dir="models/tabular_classification/preprocessing"):
