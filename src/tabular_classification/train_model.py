...
class QualityControlModelTrainer:
    ...
    def train_baseline_model(self):
        ...
        results_balanced = self.evaluate_model(lr_balanced, "lr_balanced")
    ...
    def train_with_smote(self):
        ...
        results_smote = self.evaluate_model(lr_smote, "lr_smote")
    ...
    def train_random_forest(self):
        ...
        # Evaluate
        results_rf = self.evaluate_model(rf, "random_forest")
    ...
    def train_gradient_boosting(self):
        ...
        # Evaluate 
        results_gb = self.evaluate_model(gb, "gradient_boosting")
    ...
    def plot_roc_curves(self):
        ...
        plt.savefig("results/plots/roc_curves.png", dpi=100)
        plt.close()
    ...
    def save_best_model(self):
        ...
        joblib.dump(best_model, f"models/saved_models/best_model_{best_model_name}.plk")
        ...
        with open(f"models/saved_models/best_model_metadata.json", "w") as f:
